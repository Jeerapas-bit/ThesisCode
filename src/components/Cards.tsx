...
const Cards = () => {
  ...
  const cardTypes = [
    ...
    },
    {
      ...
      carouselImages: Array.from({ length: 10 }, (_, i) => `/Card_Active_${i + 1}.png`),
    },
    {
      title: 'Passive Card',
      ...
      carouselImages: Array.from({ length: 10 }, (_, i) => `/Card_Passive_${i + 1}.png`),
    },
    {
      title: 'Debuff Card',
      ...
      carouselImages: Array.from({ length: 10 }, (_, i) => `/Card_Debuff_${i + 1}.png`),
    },
    {
      title: 'Weapon Card',
